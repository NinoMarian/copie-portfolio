document.addEventListener('DOMContentLoaded', () => {
    ...
    if (modal) {
        ...
        projectCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                modalTitle.innerHTML = title; // innerHTML pour permettre les <br>
                ...
                if (type === 'video') {
                    ...
                    // Cas : Modèle 3D
                    // C'est ici que le model-viewer est créé, uniquement quand on ouvre la modale
    ...
    // OPTIMISATION : Debounce sur le resize
    // Cela empêche la fonction de s'exécuter 100 fois par seconde quand on redimensionne
    let resizeTimer;
    window.addEventListener('resize', () => {
        clearTimeout(resizeTimer);
        resizeTimer = setTimeout(checkTextOverflow, 100);
    });
